...
128. 태스크 7에서 생성한 EC2 인스턴스의 체크박스를 선택합니다.
...
132. EC2에 SSH로 접속합니다 (태스크 7에서 이미 접속 중이면 건너뛰세요):
...
135. EC2에 SSH로 접속한 상태에서 MySQL에 root로 접속합니다:
...
137. (선택) 로컬에서 SQL 파일을 EC2로 전송하고 실행합니다:
...
141. EC2에 SSH로 접속합니다 (이미 접속 중이면 건너뛰세요):
