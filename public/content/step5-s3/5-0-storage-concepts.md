...
> Spring, Node.js 등에서 AWS SDK를 사용할 때, 코드에 Access Key를 명시하지 않아도 SDK가 자동으로 자격 증명을 찾습니다. 환경에 따라 적절한 방식이 자동 선택됩니다.
...
> [!WARNING]
> **application.properties에 Access Key를 넣지 마세요.** Git에 push되면 자동 스캐너에 의해 수 분 내에 탈취됩니다. AWS가 유출을 감지해 경고하지만, 이미 수백 달러의 비용이 발생할 수 있습니다.
