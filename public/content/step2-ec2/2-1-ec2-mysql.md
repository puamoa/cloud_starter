...
78. VPC 콘솔 → **Network ACLs**에서 `my-public-nacl`을 선택합니다.
...
83. VPC 콘솔에서 다시 **Inbound rules** 탭 → [[Edit inbound rules]]를 클릭합니다.
...
95. EC2가 있는 `my-public-subnet-a`를 체크합니다.
...
107. VPC 콘솔 → **Network ACLs**에서 `my-public-nacl`을 선택합니다.
...
112. VPC 콘솔 → **Network ACLs**에서 `test-nacl`을 선택합니다.
