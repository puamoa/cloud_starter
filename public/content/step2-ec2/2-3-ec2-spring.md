...
20. 빌드된 파일을 SCP로 EC2에 전송합니다. 본인의 방법에 맞는 명령어를 실행하세요:
...
24. **새 터미널을 열어** EC2에 다시 접속하고 테스트합니다:
...
34. EC2에서 MySQL에 접속하여 SQL을 실행합니다:
