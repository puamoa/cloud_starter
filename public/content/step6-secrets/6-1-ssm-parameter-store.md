...
4. 검색 결과에서 **Systems Manager** 서비스를 클릭합니다.
    ...
    <img src="/images/step6/6-1-step4-ssm-search.png" alt="Systems Manager 검색 결과" class="guide-img-sm" />
...
7. [[Create parameter]] 버튼을 클릭합니다.
    ...
    <img src="/images/step6/6-1-step7-create-parameter.png" alt="Create parameter 버튼" class="guide-img-sm" />
8. **Name** 필드에 `/starter/prod/db/url`을 입력합니다.

    <img src="/images/step6/6-1-step8-parameter-name.png" alt="Parameter 이름 입력" class="guide-img-sm" />
...
14. **Tags** 섹션에서 [[Add tag]]를 클릭하여 아래 태그를 추가합니다:
    ...
    <img src="/images/step6/6-1-step14-tags.png" alt="Tags 추가" class="guide-img-sm" />

15. [[Create parameter]] 버튼을 클릭합니다.

    <img src="/images/step6/6-1-step15-create-success.png" alt="파라미터 생성 성공" class="guide-img-sm" />
...
17. **Name** 필드에 `/starter/prod/db/password`를 입력합니다.
    ...
    <img src="/images/step6/6-1-step17-securestring-password.png" alt="SecureString 비밀번호 파라미터" class="guide-img-sm" />
...
24. **Tags** 섹션에서 [[Add tag]]를 클릭하여 태그를 추가합니다:
    ...
    <img src="/images/step6/6-1-step24-password-tags.png" alt="비밀번호 파라미터 태그" class="guide-img-sm" />

25. [[Create parameter]] 버튼을 클릭합니다.

    <img src="/images/step6/6-1-step25-password-created.png" alt="비밀번호 파라미터 생성 완료" class="guide-img-sm" />
...
33. **Tags** 섹션에서 [[Add tag]]를 클릭하여 동일한 태그 3개를 추가합니다:
    ...
    <img src="/images/step6/6-1-step33-username-tags.png" alt="Username 파라미터 태그" class="guide-img-sm" />

34. [[Create parameter]] 버튼을 클릭합니다.

    <img src="/images/step6/6-1-step34-username-created.png" alt="Username 파라미터 생성 완료" class="guide-img-sm" />
...
42. **Tags** 섹션에서 [[Add tag]]를 클릭하여 동일한 태그 3개를 추가합니다:
    ...
    <img src="/images/step6/6-1-step42-driver-tags.png" alt="Driver 파라미터 태그" class="guide-img-sm" />
...
51. **Tags** 섹션에서 [[Add tag]]를 클릭하여 동일한 태그 3개를 추가합니다:
    ...
    <img src="/images/step6/6-1-step51-s3-tags.png" alt="S3 버킷 파라미터 태그" class="guide-img-sm" />

52. [[Create parameter]] 버튼을 클릭합니다.

    <img src="/images/step6/6-1-step52-s3-created.png" alt="S3 버킷 파라미터 생성 완료" class="guide-img-sm" />
...
56. [[Show]] 버튼을 클릭하여 복호화된 값(`MyPassword123!`)이 표시되는지 확인합니다.
    ...
    <img src="/images/step6/6-1-step56-show-password.png" alt="SecureString 복호화 확인" class="guide-img-sm" />
...
58. AWS CloudShell을 엽니다 (콘솔 상단 우측의 `>_` 아이콘 클릭).
    ...
    <img src="/images/step6/6-1-step58-cloudshell.png" alt="AWS CloudShell" class="guide-img-sm" />
...
<img src="/images/step6/6-1-step59-put-parameter.png" alt="put-parameter 실행 결과" class="guide-img-sm" />

<img src="/images/step6/6-1-step59-put-parameter-result.png" alt="put-parameter 응답" class="guide-img-sm" />
...
<img src="/images/step6/6-1-step60-securestring-put.png" alt="SecureString 파라미터 생성" class="guide-img-sm" />
...
<img src="/images/step6/6-1-step61-overwrite.png" alt="파라미터 overwrite" class="guide-img-sm" />
...
<img src="/images/step6/6-1-step62-get-parameter.png" alt="get-parameter 결과" class="guide-img-sm" />
...
<img src="/images/step6/6-1-step63-no-decryption.png" alt="복호화 없이 조회" class="guide-img-sm" />
...
<img src="/images/step6/6-1-step64-with-decryption.png" alt="복호화하여 조회" class="guide-img-sm" />
...
<img src="/images/step6/6-1-step65-get-by-path.png" alt="경로 기반 일괄 조회" class="guide-img-sm" />
...
<img src="/images/step6/6-1-step66-delete-parameter.png" alt="파라미터 삭제" class="guide-img-sm" />

<img src="/images/step6/6-1-step66-delete-result.png" alt="파라미터 삭제 결과" class="guide-img-sm" />
...
<img src="/images/step6/6-1-step67-gradle-boot.png" alt="Spring Boot build.gradle" class="guide-img-sm" />
...
<img src="/images/step6/6-1-step67-gradle-mvc.png" alt="Spring MVC build.gradle" class="guide-img-sm" />
...
<img src="/images/step6/6-1-step69-parameter-store-service.png" alt="ParameterStoreService 코드" class="guide-img-sm" />
...
<img src="/images/step6/6-1-step72-rootconfig.png" alt="RootConfig 수정" class="guide-img-sm" />
...
<img src="/images/step6/6-1-step73-local-datasource.png" alt="LocalDataSourceConfig" class="guide-img-sm" />
...
<img src="/images/step6/6-1-step74-aws-datasource.png" alt="AwsDataSourceConfig" class="guide-img-sm" />
...
<img src="/images/step6/6-1-step5f-boot-test.png" alt="Boot aws 프로필 테스트" class="guide-img-sm" />
...
<img src="/images/step6/6-1-step5f-legacy-test.png" alt="레거시 aws 프로필 테스트" class="guide-img-sm" />
...
<img src="/images/step6/6-1-step5f-sdk-test.png" alt="SDK 단독 테스트 결과" class="guide-img-sm" />
...
78. [[Create policy]] 버튼을 클릭합니다.
    ...
    <img src="/images/step6/6-1-step78-create-policy.png" alt="Create policy" class="guide-img-sm" />
...
<img src="/images/step6/6-1-step80-policy-json.png" alt="IAM 정책 JSON" class="guide-img-sm" />
...
84. **Tags** 섹션에서 [[Add tag]]를 클릭하여 태그를 추가합니다:
    ...
    <img src="/images/step6/6-1-step84-policy-tags.png" alt="정책 태그" class="guide-img-sm" />

85. [[Create policy]] 버튼을 클릭합니다.

    <img src="/images/step6/6-1-step85-policy-created.png" alt="정책 생성 완료" class="guide-img-sm" />
...
87. [[Create role]] 버튼을 클릭합니다.
    ...
    <img src="/images/step6/6-1-step87-create-role.png" alt="Create role" class="guide-img-sm" />
...
90. 하단의 `EC2` 라디오 버튼이 선택되어 있는지 확인합니다.
    ...
    <img src="/images/step6/6-1-step90-ec2-usecase.png" alt="EC2 Use case 선택" class="guide-img-sm" />
91. [[Next]] 버튼을 클릭합니다.

92. **Permissions policies** 검색창에 `starter-ssm-read-policy`를 입력합니다.
93. 검색 결과에서 `starter-ssm-read-policy` 왼쪽의 체크박스를 클릭합니다.

    <img src="/images/step6/6-1-step93-attach-policy.png" alt="정책 연결" class="guide-img-sm" />
94. [[Next]] 버튼을 클릭합니다.
...
97. **Tags** 섹션에서 [[Add tag]]를 클릭하여 태그를 추가합니다:
    ...
    <img src="/images/step6/6-1-step97-role-tags.png" alt="Role 태그" class="guide-img-sm" />

98. 페이지 하단의 [[Create role]] 버튼을 클릭합니다.

    <img src="/images/step6/6-1-step98-role-created.png" alt="Role 생성 완료" class="guide-img-sm" />
...
104. **Security** → **Modify IAM role**을 선택합니다.
     ...
     <img src="/images/step6/6-1-step104-modify-iam-role.png" alt="Modify IAM role" class="guide-img-sm" />

105. **IAM role** 드롭다운에서 `ec2-starter-role`을 선택합니다.

     <img src="/images/step6/6-1-step105-select-role.png" alt="Role 선택" class="guide-img-sm" />

106. [[Update IAM role]] 버튼을 클릭합니다.

     <img src="/images/step6/6-1-step106-update-role.png" alt="IAM Role 업데이트 완료" class="guide-img-sm" />
...
<img src="/images/step6/6-1-step107-ssh-connect.png" alt="SSH 접속" class="guide-img-sm" />
...
<img src="/images/step6/6-1-step108-ec2-get-param.png" alt="EC2에서 파라미터 조회" class="guide-img-sm" />
...
<img src="/images/step6/6-1-step109-ec2-decrypt.png" alt="EC2에서 SecureString 복호화 조회" class="guide-img-sm" />
...
4. [[Search resources]] 버튼을 클릭합니다.
    ...
    <img src="/images/step6/6-1-cleanup4-tag-editor.png" alt="Tag Editor 검색 결과" class="guide-img-sm" />
...
6. AWS Management Console 상단 검색창에 `EC2`를 입력하고 선택합니다.
7. 왼쪽 메뉴에서 **Instances**를 클릭합니다.
8. `ec2-starter-role`이 연결된 Amazon EC2 인스턴스의 체크박스를 클릭합니다.
9. **Actions** → **Security** → **Modify IAM role**을 선택합니다.
10. **IAM role** 드롭다운에서 `No IAM Role`을 선택합니다 (빈 값 선택).

    <img src="/images/step6/6-1-cleanup10-ec2-role-detach.png" alt="EC2에서 Role 분리" class="guide-img-sm" />
11. [[Update IAM role]] 버튼을 클릭합니다.
...
12. AWS Management Console 상단 검색창에 `IAM`을 입력하고 선택합니다.
13. 왼쪽 메뉴에서 **Roles**를 클릭합니다.
14. 검색창에 `ec2-starter-role`을 입력합니다.
15. `ec2-starter-role`을 클릭하여 상세 페이지로 이동합니다.

16. **Permissions** 탭에서 `starter-ssm-read-policy` 오른쪽의 [[Remove]] 버튼을 클릭합니다.

    <img src="/images/step6/6-1-cleanup16-role-delete.png" alt="정책 분리" class="guide-img-sm" />

17. 확인 팝업에서 [[Remove]] 버튼을 클릭합니다.

    <img src="/images/step6/6-1-cleanup17-role-deleted.png" alt="정책 분리 확인" class="guide-img-sm" />
...
18. 왼쪽 메뉴에서 **Roles**를 클릭합니다.
19. 검색창에 `ec2-starter-role`을 입력합니다.
20. `ec2-starter-role` 왼쪽의 라디오 버튼을 클릭합니다.
21. [[Delete]] 버튼을 클릭합니다.


22. 확인 팝업에서 Role 이름 `ec2-starter-role`을 입력합니다.
...
24. 왼쪽 메뉴에서 **Policies**를 클릭합니다.
25. 검색창에 `starter-ssm-read-policy`를 입력합니다.
26. `starter-ssm-read-policy` 왼쪽의 라디오 버튼을 클릭합니다.
27. **Actions** 드롭다운을 클릭합니다.
28. [[Delete]]를 선택합니다.
29. 확인 팝업에서 정책 이름 `starter-ssm-read-policy`를 입력합니다.
30. [[Delete]] 버튼을 클릭합니다.
...
31. AWS Management Console 상단 검색창에 `Systems Manager`를 입력하고 선택합니다.
32. 왼쪽 메뉴에서 **Parameter Store**를 클릭합니다.
33. `/starter/prod/db/driver` 왼쪽의 체크박스를 클릭합니다.
34. `/starter/prod/db/url` 왼쪽의 체크박스를 클릭합니다.
35. `/starter/prod/db/username` 왼쪽의 체크박스를 클릭합니다.
36. `/starter/prod/db/password` 왼쪽의 체크박스를 클릭합니다.
37. `/starter/prod/s3/bucket` 왼쪽의 체크박스를 클릭합니다.

    <img src="/images/step6/6-1-cleanup37-param-delete.png" alt="Parameter Store 삭제" class="guide-img-sm" />

38. [[Delete]] 버튼을 클릭합니다.
39. 확인 팝업에서 [[Delete parameters]] 버튼을 클릭합니다.

    <img src="/images/step6/6-1-cleanup39-tag-final.png" alt="Parameter Store 삭제 확인" class="guide-img-sm" />
...
40. **Parameter Store** 목록에서 `/starter/prod/` 경로의 파라미터가 없는지 확인합니다.
41. **IAM → Policies**에서 `starter-ssm-read-policy`를 검색하여 결과가 없는지 확인합니다.
42. **IAM → Roles**에서 `ec2-starter-role`을 검색하여 결과가 없는지 확인합니다.

### Tag Editor로 최종 확인

43. AWS Management Console 상단 검색창에 `Resource Groups & Tag Editor`를 입력하고 선택합니다.

44. 왼쪽 메뉴에서 **Tag Editor**를 클릭합니다.
45. 다음과 같이 설정합니다:
    - **Regions**: `ap-northeast-2`
    - **Resource types**: `All supported resource types`
    - **Tags**: Tag key = `Session`, Tag value = `6-1`
...
46. [[Search resources]] 버튼을 클릭합니다.
47. 검색 결과에 리소스가 표시되지 않으면 모든 리소스가 성공적으로 삭제된 것입니다.
