...
5. **Prerequisite - Prepare template**에서 `Choose an existing template`을 선택합니다.
   <img src="/images/step7/7-3-step5-cf-create-stack.png" alt="Create stack" class="guide-img-sm" />
6. **Specify template**에서 `Upload a template file`을 선택합니다.
7. [[Choose file]] 버튼을 클릭하고 다운로드한 `step7-3-asg-prereq.yaml` 파일을 선택합니다.
8. [[Next]] 버튼을 클릭합니다.
9. **Stack name**에 `step7-3-asg-prereq`를 입력합니다.
   <img src="/images/step7/7-3-step9-parameters.png" alt="Stack name 및 Parameters" class="guide-img-sm" />
...
13. **Review and create** 페이지에서 설정 내용을 확인합니다.
    <img src="/images/step7/7-3-step13-create-complete.png" alt="Review and create" class="guide-img-sm" />
14. [[Submit]] 버튼을 클릭합니다.
    <img src="/images/step7/7-3-step14-submit.png" alt="Submit" class="guide-img-sm" />
...
15. EC2 콘솔 → **Instances** → **Launch Templates**로 이동합니다.
    <img src="/images/step7/7-3-step15-launch-templates.png" alt="Launch Templates 메뉴" class="guide-img-sm" />
16. [[Create launch template]]을 클릭합니다.

### Launch template name and description

17. **Launch template name**: `starter-app-lt`
    <img src="/images/step7/7-3-step17-lt-name.png" alt="Launch template name" class="guide-img-sm" />
...
21. **Quick Start** → **Amazon Linux** 선택
    <img src="/images/step7/7-3-step21-ami-select.png" alt="AMI 선택" class="guide-img-sm" />
...
23. **Instance type**: `t3.micro`
    <img src="/images/step7/7-3-step23-instance-type.png" alt="Instance type 선택" class="guide-img-sm" />
...
25. **Security groups**: EC2용 Security Group을 선택합니다.
    ...
    - 또는 AWS CloudFormation으로 생성된 `EC2SecurityGroup`
      <img src="/images/step7/7-3-step25-key-pair.png" alt="Key pair 및 Network settings" class="guide-img-sm" />
...
26. **Resource tags** 섹션을 펼치고 [[Add tag]]를 클릭하여 태그를 추가합니다:
    ...
    - **Key**: `CreatedBy`, **Value**: `admin-user`
      <img src="/images/step7/7-3-step26-network-settings.png" alt="Resource tags" class="guide-img-sm" />
    - **Key**: `Step`, **Value**: `step7`
    - **Key**: `Session`, **Value**: `7-3`
...
<img src="/images/step7/7-3-step28-userdata.png" alt="User Data 입력" class="guide-img-sm" />
...
29. [[Create launch template]]을 클릭합니다.
    <img src="/images/step7/7-3-step29-lt-created1.png" alt="Launch Template 생성 1" class="guide-img-sm" />
    <img src="/images/step7/7-3-step29-lt-created2.png" alt="Launch Template 생성 2" class="guide-img-sm" />
    <img src="/images/step7/7-3-step29-lt-created3.png" alt="Launch Template 생성 3" class="guide-img-sm" />
...
30. EC2 콘솔 → **Auto Scaling** → **Auto Scaling Groups**로 이동합니다.
    <img src="/images/step7/7-3-step30-asg-menu.png" alt="Auto Scaling Groups 메뉴" class="guide-img-sm" />
31. [[Create Auto Scaling group]]을 클릭합니다.

### Step 1: Choose launch template

32. **Auto Scaling group name**: `starter-app-asg`
    <img src="/images/step7/7-3-step32-lt-select.png" alt="ASG name 및 Launch template 선택" class="guide-img-sm" />
...
36. **VPC**: 실습용 VPC를 선택합니다 (예: `asg-lab-vpc`).
    <img src="/images/step7/7-3-step36-network.png" alt="VPC 선택" class="guide-img-sm" />
37. **Availability Zones and subnets**: 2개의 Public Subnet을 선택합니다.
    <img src="/images/step7/7-3-step37-az-subnets.png" alt="AZ 및 Subnet 선택" class="guide-img-sm" />
...
39. **Select Load balancing options**: **Attach to an existing load balancer**를 선택합니다.
    - 기본값은 "No load balancer"이지만, ALB와 연동해야 하므로 변경합니다.
      <img src="/images/step7/7-3-step39-alb-attach.png" alt="ALB 연결" class="guide-img-sm" />
...
48. **Desired capacity type**: `Units (number of instances)` (기본값)
    <img src="/images/step7/7-3-step48-group-size.png" alt="Group size 설정" class="guide-img-sm" />
...
55. 알림이 필요하면 SNS Topic을 설정합니다. 이 실습에서는 건너뜁니다.
    <img src="/images/step7/7-3-step55-tags.png" alt="Notifications" class="guide-img-sm" />
56. [[Next]]를 클릭합니다.
...
57. [[Add tag]]를 클릭하여 다음 태그를 추가합니다:
    ...
    - **Key**: `CreatedBy`, **Value**: `admin-user`, ✅ **Tag new instances** 체크
      <img src="/images/step7/7-3-step57-review.png" alt="Tags 및 Review" class="guide-img-sm" />
...
59. 설정을 검토합니다:
    ...
    - Scaling policy: CPU 70% Target Tracking
      <img src="/images/step7/7-3-step59-create-asg.png" alt="ASG Review" class="guide-img-sm" />
60. [[Create Auto Scaling group]]을 클릭합니다.
    <img src="/images/step7/7-3-step60-asg-created1.png" alt="ASG 생성 완료 1" class="guide-img-sm" />
    <img src="/images/step7/7-3-step60-asg-created2.png" alt="ASG 생성 완료 2" class="guide-img-sm" />
...
62. **Activity** 탭을 클릭합니다.
    <img src="/images/step7/7-3-step62-instances-running.png" alt="ASG Activity 탭" class="guide-img-sm" />
...
64. **Automatic scaling** 탭을 클릭합니다.
    <img src="/images/step7/7-3-step64-tg-healthy.png" alt="Automatic scaling 탭" class="guide-img-sm" />
...
68. 왼쪽 메뉴에서 **Alarms**를 클릭합니다.
    <img src="/images/step7/7-3-step68-alb-access.png" alt="CloudWatch Alarms" class="guide-img-sm" />
69. ASG가 자동으로 생성한 알람 2개를 확인합니다:
    <img src="/images/step7/7-3-step69-cw-alarms1.png" alt="CloudWatch 알람 1" class="guide-img-sm" />
    <img src="/images/step7/7-3-step69-cw-alarms2.png" alt="CloudWatch 알람 2" class="guide-img-sm" />
...
>
> <img src="/images/step7/7-3-step70-tip-alb.png" alt="Desired capacity 조정" class="guide-img-sm" />

70. EC2 콘솔 → **Instances**로 이동합니다.
    <img src="/images/step7/7-3-step70-instances.png" alt="EC2 인스턴스 확인" class="guide-img-sm" />
...
74. **Targets** 탭에서 등록된 인스턴스를 확인합니다:
    <img src="/images/step7/7-3-step74-alb-access.png" alt="Target Group 상태 확인" class="guide-img-sm" />
...
75. Load Balancers → `starter-alb` (또는 `asg-lab-alb`) → DNS name 복사
    <img src="/images/step7/7-3-step75-alb-dns.png" alt="ALB DNS name 복사" class="guide-img-sm" />
76. 브라우저에서 접속합니다:
...
77. 여러 번 새로고침하여 트래픽이 분산되는지 확인합니다.
    - User Data에서 인스턴스 식별 페이지를 설정했으므로 새로고침할 때마다 Instance ID와 AZ가 바뀌는 것을 확인할 수 있습니다.
      <img src="/images/step7/7-3-step77-browser-access.png" alt="ALB 접속 확인" class="guide-img-sm" />

### 인스턴스 자동 복구 테스트

78. EC2 콘솔에서 ASG가 생성한 인스턴스 1개를 **수동으로 종료**합니다.
    - 인스턴스 선택 → **Instance state** → [[Terminate instance]]
      <img src="/images/step7/7-3-step78-terminate1.png" alt="인스턴스 종료 1" class="guide-img-sm" />
      <img src="/images/step7/7-3-step78-terminate2.png" alt="인스턴스 종료 2" class="guide-img-sm" />

79. 1~2분 후 ASG가 새 인스턴스를 자동으로 생성하는지 확인합니다.
    <img src="/images/step7/7-3-step79-self-healing1.png" alt="자동 복구 1" class="guide-img-sm" />
    <img src="/images/step7/7-3-step79-self-healing2.png" alt="자동 복구 2" class="guide-img-sm" />
...
80. ASG가 생성한 인스턴스 중 하나의 Public IP를 확인합니다.
    - EC2 콘솔 → Instances → `starter-app-asg-instance` 선택 → **Public IPv4 address** 복사
      <img src="/images/step7/7-3-step80-stress-install.png" alt="인스턴스 Public IP 확인" class="guide-img-sm" />
81. SSH로 접속합니다:
...
<img src="/images/step7/7-3-step81-stress-run.png" alt="SSH 접속" class="guide-img-sm" />
...
<img src="/images/step7/7-3-step82-monitoring.png" alt="v2 코드 수정" class="guide-img-sm" />

83. 브라우저에서 해당 인스턴스 IP로 접속하여 v2 페이지가 표시되는지 확인합니다.
    <img src="/images/step7/7-3-step83-scale-out.png" alt="v2 페이지 확인" class="guide-img-sm" />
...
86. **Actions** → **Image and templates** → **Create image**를 클릭합니다.
    <img src="/images/step7/7-3-step86-create-image.png" alt="Create image" class="guide-img-sm" />
87. 다음을 설정합니다:
    <img src="/images/step7/7-3-step87-image-settings.png" alt="Image 설정" class="guide-img-sm" />
...
88. [[Create image]]를 클릭합니다.
    <img src="/images/step7/7-3-step88-create-image-done.png" alt="Create image 완료" class="guide-img-sm" />
89. 왼쪽 메뉴 **Images** → **AMIs**에서 생성 상태를 확인합니다.
    - Status: `pending` → `available` (2~5분 소요)
      <img src="/images/step7/7-3-step89-ami-available1.png" alt="AMI 상태 확인 1" class="guide-img-sm" />
      <img src="/images/step7/7-3-step89-ami-available2.png" alt="AMI 상태 확인 2" class="guide-img-sm" />
...
>
> <img src="/images/step7/7-3-step89-ami-note.png" alt="AMI 비용 참고" class="guide-img-sm" />

### Launch Template 새 버전 생성

90. EC2 콘솔 → **Instances** → **Launch Templates**로 이동합니다.
    <img src="/images/step7/7-3-step90-lt-menu.png" alt="Launch Templates" class="guide-img-sm" />
91. `starter-app-lt`를 선택하고 **Actions** → **Modify template (Create new version)**을 클릭합니다.
    <img src="/images/step7/7-3-step91-modify-template.png" alt="Modify template" class="guide-img-sm" />
92. **Template version description**: `v2 - Custom AMI with purple theme`
    <img src="/images/step7/7-3-step92-source-version.png" alt="Template version 설정" class="guide-img-sm" />
93. **Source template version**: `1 (Default)` 선택
94. **Application and OS Images (AMI)** 섹션에서:
    - 현재 공식 AMI(Amazon Linux 2023)가 선택되어 있습니다.
    - **My AMIs** 탭을 클릭합니다.
    - **Owned by me**에서 `starter-app-ami-v2`를 선택합니다.
      <img src="/images/step7/7-3-step94-my-ami.png" alt="My AMI 선택" class="guide-img-sm" />
95. 나머지 항목은 v1에서 가져온 값이 자동 유지되므로 변경하지 않습니다:
    - **Instance type**: `t3.micro` (유지)
    - **Key pair**: 기존 Key Pair (유지)
    - **Network settings**: Security Group (유지)
      <img src="/images/step7/7-3-step95-remaining1.png" alt="나머지 설정 유지 1" class="guide-img-sm" />
      <img src="/images/step7/7-3-step95-remaining2.png" alt="나머지 설정 유지 2" class="guide-img-sm" />
96. **Storage (volumes)**: 기본값 유지 (AMI에 포함된 볼륨 정보가 자동 표시됨)

> [!NOTE]
> "AMI Volumes are not included in the template unless modified"로 표시되면 정상입니다.  
> 커스텀 AMI의 스냅샷이 인스턴스 시작 시 자동으로 적용됩니다.

97. **Advanced details**를 펼칩니다.
98. 맨 아래 **User Data** 영역의 내용을 모두 삭제합니다 (비워둡니다).
    <img src="/images/step7/7-3-step98-userdata-clear.png" alt="User Data 삭제" class="guide-img-sm" />

> [!TIP]
> 커스텀 AMI에는 이미 Nginx + 설정이 포함되어 있으므로 User Data가 불필요합니다.  
> User Data를 비우지 않으면 인스턴스 시작 시 스크립트가 다시 실행되어 AMI의 설정을 덮어쓸 수 있습니다.

99. 하단 **Summary**에서 설정을 확인합니다:
    - Software Image (AMI): `starter-app-ami-v2`
    - Virtual server type: `t3.micro`
    - Firewall: EC2 Security Group
    - Storage: 1 volume(s) - 8 GiB
      <img src="/images/step7/7-3-step99-summary.png" alt="Summary 확인" class="guide-img-sm" />
100. [[Create template version]]을 클릭합니다.
     <img src="/images/step7/7-3-step100-lt-version1.png" alt="Create template version 1" class="guide-img-sm" />
     <img src="/images/step7/7-3-step100-lt-version2.png" alt="Create template version 2" class="guide-img-sm" />

### ASG 확인

태스크 3에서 ASG 생성 시 Version을 `Latest`로 설정했으므로, 새 버전(v2)이 자동으로 반영됩니다.

101. EC2 콘솔 → **Auto Scaling** → **Auto Scaling Groups** → `starter-app-asg`를 클릭합니다.
     <img src="/images/step7/7-3-step101-asg-latest.png" alt="ASG Latest 확인" class="guide-img-sm" />
102. **Details** 탭에서 Launch template의 Version이 `Latest`로 설정되어 있는지 확인합니다.
...
103. ASG가 생성한 인스턴스 **각각**에 SSH 터미널을 열어 접속합니다:

```bash
ssh -i your-key.pem ec2-user@<instance-public-ip>
```

104. stress 도구를 설치합니다:
...
<img src="/images/step7/7-3-step104-stress-install.png" alt="stress 설치" class="guide-img-sm" />
...
<img src="/images/step7/7-3-step105-stress-run1.png" alt="stress 실행 1" class="guide-img-sm" />
<img src="/images/step7/7-3-step105-stress-run2.png" alt="stress 실행 2" class="guide-img-sm" />

> [!WARNING]
> 103번에서 접속한 **모든 인스턴스**에서 위 명령을 동시에 실행해야 합니다.  
> 1대에서만 실행하면 평균 CPU가 목표값(70%)을 초과하지 않아 Scale Out이 발생하지 않습니다.
>
> <img src="/images/step7/7-3-step105-warning.png" alt="모든 인스턴스에서 실행" class="guide-img-sm" />

> [!NOTE]
> t3.micro는 vCPU 2개이므로 `--cpu 2`로 CPU 100%를 달성할 수 있습니다.  
...
>
> <img src="/images/step7/7-3-step105-tip.png" alt="Scale Out 팁" class="guide-img-sm" />

### Scale Out 확인

106. **5~7분 후** ASG Activity를 확인합니다:
     <img src="/images/step7/7-3-step106-scale-out-activity.png" alt="Scale Out Activity" class="guide-img-sm" />
...
107. EC2 콘솔에서 인스턴스가 3개로 증가했는지 확인합니다.
     <img src="/images/step7/7-3-step107-instances-3.png" alt="인스턴스 3개 확인" class="guide-img-sm" />
108. Target Group에서 새 인스턴스가 등록되고 healthy 상태가 되는지 확인합니다.

### Scale In 확인

109. stress 명령이 종료된 후 (10분 후) CPU가 정상으로 돌아옵니다.
110. **약 15분 후** Scale In이 발생합니다:
     - Activity 탭에서 "Terminating EC2 instance" 이력 확인
     - 인스턴스 1개가 자동 종료됨
       <img src="/images/step7/7-3-step110-scale-in1.png" alt="Scale In 1" class="guide-img-sm" />
       <img src="/images/step7/7-3-step110-scale-in2.png" alt="Scale In 2" class="guide-img-sm" />
       <img src="/images/step7/7-3-step110-scale-in3.png" alt="Scale In 3" class="guide-img-sm" />
       <img src="/images/step7/7-3-step110-scale-in4.png" alt="Scale In 4" class="guide-img-sm" />
       <img src="/images/step7/7-3-step110-cli-activity.png" alt="Scale In Activity" class="guide-img-sm" />
...
<img src="/images/step7/7-3-step110-cli-ref1.png" alt="CLI 스케일링 활동 1" class="guide-img-sm" />
<img src="/images/step7/7-3-step110-cli-ref2.png" alt="CLI 스케일링 활동 2" class="guide-img-sm" />
...
>
> <img src="/images/step7/7-3-selfmission-asg-zero.png" alt="ASG Min/Desired/Max 0 설정" class="guide-img-sm" />
...
4. [[Search resources]]를 클릭합니다.
   <img src="/images/step7/7-3-cleanup4-tag-editor.png" alt="Tag Editor 검색" class="guide-img-sm" />
...
8. 상단 **Actions** 드롭다운 → **Delete**를 클릭합니다.
   <img src="/images/step7/7-3-cleanup8-asg-delete.png" alt="ASG Delete" class="guide-img-sm" />
9. 확인 입력란에 `delete`를 입력합니다.
10. [[Delete]]를 클릭합니다.
    <img src="/images/step7/7-3-cleanup10-asg-confirm.png" alt="ASG 삭제 확인" class="guide-img-sm" />
    <img src="/images/step7/7-3-cleanup10-asg-confirm2.png" alt="ASG 삭제 확인 2" class="guide-img-sm" />
11. Amazon EC2 콘솔 → **Instances**에서 ASG가 관리하던 인스턴스가 `Shutting down` → `Terminated` 상태로 변경되는 것을 확인합니다 (약 3-5분).
    <img src="/images/step7/7-3-cleanup11-instances-terminated.png" alt="인스턴스 Terminated" class="guide-img-sm" />
...
14. **Actions** → **Delete template**을 클릭합니다.
    <img src="/images/step7/7-3-cleanup14-lt-actions.png" alt="Launch Template 삭제" class="guide-img-sm" />
15. 확인 입력란에 `Delete`를 입력합니다.
    <img src="/images/step7/7-3-cleanup15-lt-confirm.png" alt="Delete 입력" class="guide-img-sm" />
16. [[Delete]]를 클릭합니다.
    <img src="/images/step7/7-3-cleanup16-lt-deleted.png" alt="Launch Template 삭제 완료" class="guide-img-sm" />
...
19. **Actions** → **Deregister AMI**를 클릭합니다.
    <img src="/images/step7/7-3-cleanup19-ami-deregister.png" alt="AMI Deregister" class="guide-img-sm" />
20. 확인 팝업에서 [[Deregister AMI]]를 클릭합니다.
    <img src="/images/step7/7-3-cleanup20-ami-confirm.png" alt="AMI Deregister 확인" class="guide-img-sm" />
...
23. 상단 **Actions** → **Delete snapshot**을 클릭합니다.
    <img src="/images/step7/7-3-cleanup23-snapshot-actions.png" alt="Delete snapshot" class="guide-img-sm" />
24. 확인 입력란에 `delete`를 입력합니다.
    <img src="/images/step7/7-3-cleanup24-snapshot-confirm.png" alt="snapshot 삭제 확인" class="guide-img-sm" />
25. [[Delete]]를 클릭합니다.
    <img src="/images/step7/7-3-cleanup25-snapshot-deleted.png" alt="snapshot 삭제 완료" class="guide-img-sm" />
...
38. [[Delete]] 버튼을 클릭합니다.
39. 확인 팝업에서 스택 이름 `step7-3-asg-prereq`를 입력하고 [[Delete stack]]을 클릭합니다.
    <img src="/images/step7/7-3-cleanup39-cfn-confirm.png" alt="CloudFormation 스택 삭제 확인" class="guide-img-sm" />
40. 스택 상태가 `DELETE_IN_PROGRESS` → `DELETE_COMPLETE`가 될 때까지 기다립니다 (약 3-5분).
    <img src="/images/step7/7-3-cleanup40-cfn-deleted.png" alt="CloudFormation 스택 삭제 완료" class="guide-img-sm" />
...
48. 검색 결과가 없으면 모든 태그된 리소스가 정리된 것입니다.
    <img src="/images/step7/7-3-cleanup47-final-check.png" alt="Tag Editor 최종 확인" class="guide-img-sm" />
