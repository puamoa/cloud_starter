...
>
> - `asg-lab-prereq.yaml` - AWS CloudFormation 템플릿 (태스크 0에서 VPC, 서브넷, IGW, ALB, Target Group, Security Group 자동 생성)
...
2. **Stacks** 목록에서 `asg-lab-prereq` 스택을 선택합니다.
3. [[Delete]] 버튼을 클릭합니다.
...
5. CloudFormation 콘솔에서 `asg-lab-prereq` 스택이 목록에서 사라졌는지 확인합니다.
