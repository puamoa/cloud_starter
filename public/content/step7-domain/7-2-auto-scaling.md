...
| **7-2 (이번 실습)** | Auto Scaling Group | 자동 확장/축소, Launch Template |
...
>
> - `step7-2-asg-prereq.yaml` — AWS CloudFormation 템플릿 (VPC, 서브넷, IGW, ALB, Target Group, Security Group 자동 생성)
...
89. **Stacks** 목록에서 `step7-2-asg-prereq` 스택을 선택합니다.
90. [[Delete]] 버튼을 클릭합니다.
...
100.  CloudFormation 콘솔에서 `step7-2-asg-prereq` 스택이 목록에서 사라졌는지 확인합니다.
