...
> 기존 리소스가 있어도 간단히 테스트하고 싶다면 태스크 0의 CloudFormation을 실행해도 좋습니다. 별도 VPC가 생성되므로 기존 환경에 영향을 주지 않습니다.
...
> [!TIP]
> 다음 실습(Step 7-2)에서는 Auto Scaling Group을 사용하여 인스턴스 수동 등록 대신 **자동 확장/축소**를 구현합니다.
