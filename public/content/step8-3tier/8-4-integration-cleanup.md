...
이 실습에서는 Step 8-1~9-3에서 구축한 3-Tier 아키텍처의 전체 연동을 확인하고,
...
> 도메인이 없어도 Amazon CloudFront URL과 ALB DNS로 서비스를 사용할 수 있습니다.
...
13. **Domain names**에 다음을 입력합니다:
    - `yourdomain.com`
    - [[Add another name to this certificate]]를 클릭하고 `*.yourdomain.com` 추가
...
33. 다음과 같이 설정합니다:
    ...
    - **Default SSL/TLS server certificate**: ap-northeast-2에서 발급한 `api.yourdomain.com` 인증서 선택
34. [[Add]] 버튼을 클릭합니다.
...
### 단계 14: AWS CloudFormation 스택 일괄 삭제
